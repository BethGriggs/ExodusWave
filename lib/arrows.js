    ...
    mouseMoveHandler.setInputAction(function (movement) {
            ...
            if (Cesium.defined(pickedObject)) {
                ...
                if (dataJson.data["1960"].hasOwnProperty(objectName)) {
                    ...
                    var yearString = "";
                    var i = startYear;
                    for (i; i <= endYear; i += 10) {
                        yearString += "<tr><td>" + i + "</td><td style='text-align:right;'>" + dataHandler.data.data[i][countries[0]].to[countries[1]] + "</td></tr>";
                    }
                    infoDisplayValue.innerHTML = yearString;
                }
            }
